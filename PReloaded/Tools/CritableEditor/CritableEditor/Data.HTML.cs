...
namespace CritableEditor
{
    public static partial class Data
    {
        ...
        public static void SaveHtml_Men()
        {
            StreamWriter file;
            file = File.CreateText(FileHTML_Men);
            file.WriteLine("<html><head><title>Critical hit table - Men</title></head>");
            file.WriteLine("<body>");
            file.WriteLine("<a name=\"start\">");
            ...
            for (int bt = 0; bt < 1; bt++)
            {
                ...
                for (int bp = 0; bp < 9; bp++)
                {
                    file.WriteLine("<tr><th colspan=\"4\">" + Bodypart[bp] + "</th></tr>");
                    for (int num = 0; num < 6; num++)
                    {
                        int idx = num * 7 + bp * 42 + bt * 42 * 9;
                        file.WriteLine("<tr>");
        ...
        public static void OpenHtml_Men()
        {
            Process.Start(FileHTML_Men);
        }
    }
}