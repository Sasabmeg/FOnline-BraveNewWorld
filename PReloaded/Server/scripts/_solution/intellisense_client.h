...
bool __ConfigMsFov;
uint8 __ConfigOnHeadAwareness;
bool __ConfigShowNpcAwareness;
bool __ConfigShowPlayerAwareness;
bool __ConfigShowFactionEmblems;
bool __ConfigCustomBorder;
uint8 __ConfigCustomBorderRange;
uint __ConfigCustomBorderColor;
uint8 __ConfigWallRoofAlpha;
bool __ForceHelpInfo;
uint8 __ConfigGameInfo;
...
class CritterCl
{
	...
	void GetNameTextInfo(bool&inout nameVisible, int&inout x, int&inout y, int&inout w, int&inout h, int&inout lines) const; // Arguments for this function have been guessed
	bool IsInjured();
	bool IsDmgEye();
	bool IsDmgLeg();
	bool IsDmgTwoLeg();
...
bool get___ConsoleActive();
bool get___WorldmapActive();
bool get___WorldmapWait();
float get___WorldmapZoom();
int get___WorldmapOffsetX();
int get___WorldmapOffsetY();
int get___WorldmapGroupCurX();
int get___WorldmapGroupCurY();
int get___WorldmapGroupToX();
int get___WorldmapGroupToY();
float get___WorldmapGroupSpeed();
...
bool SetEffect(int, int, string@, string@ arg3 = null);
void RefreshMap(bool onlyTiles, bool onlyRoof, bool onlyLight);
void MouseClick(int x, int y, int button, int cursor);
void KeyboardPress(uint8, uint8, string@ arg2 = null, string@ arg3 = null);
bool SaveScreenshot();
bool SaveLogFile();
